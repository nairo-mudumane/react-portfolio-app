    ...
    return (
      <StyledCardProject isDark={isDark}>
        <Card className="card">
          <a
            target="_blank"
            className="link link-card-media"
          ...
          <CardContent>
            <Box className="project-title">
              <a target="_blank" className="link" href={props.project.link.url}>
                <Link className="icon" />
            ...
            <Box className="tools">
              {props.project.tools.map((tool, index) => (
                <Chip key={index} label={tool} className="chip" />
              ))}
            </Box>
          </CardContent>
        </Card>
        ...
        <Card className="card">
          ...
          <CardContent>
            ...
            <Box className="git-data">
              <Typography variant="body2" className="text-muted git-info">
                <Eye className="icon" />
                {"23k"}
              </Typography>
