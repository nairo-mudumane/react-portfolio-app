...
import { PROFILE_COVER } from "../config";
      ...
      <Container>
        <Box className="content">
          <Box className="hero">
            ...
            <Typography variant="h1" component="h1" className="title text">
              Nairo Mudumane
            </Typography>
            ...
            <Typography variant="body1" className="text">
              Unfortunately, this portfolio is in the maintenance process. Sorry
              for the inconvenience and I guarantee that I will be making the
              new version available as soon as I can.
            </Typography>
